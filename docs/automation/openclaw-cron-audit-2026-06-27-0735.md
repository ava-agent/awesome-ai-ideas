# OpenClaw Cron Audit 2026-06-27-0735

- Generated at: 2026-06-27 07:35:05 +0800
...
| --- | --- | --- | --- | --- | ---: | --- |
| OpenClaw Cron任务体系自检 每日07:35 | true | running | command | cron 35 7 * * * Asia/Shanghai | 1782516900000 | ok |
...
| Workspace Git状态巡检 每4小时（只读） | true | ok | command | every 14400000ms | 1782530980567 | ok |
| AI Ideas PR只读巡检 每6小时 | true | ok | command | every 21600000ms | 1782531046068 | ok |
| AI Ideas quality快照 每日4次 | true | ok | command | cron 50 11,15,19,23 * * * Asia/Shanghai | 1782532200000 | ok |
...
| MEMORY整理 23:30 | true | ok | agentTurn | cron 30 23 * * * Asia/Shanghai | 1782574200000 | ok |
